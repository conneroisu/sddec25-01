"""
Render DSASegmentationModel architecture using torchview.
"""

import torch
from torchview import draw_graph

from model import DSASegmentationModel
...
def render_model(
    ...
    """
    Render the DSASegmentationModel architecture to an image.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Render DSASegmentationModel architecture"
    )
    parser.add_argument(
        "-o",
        "--output",
        type=str,
        default="model_architecture_dsa",
