...
improving speed from 160ms to approximately 8.3ms per frame through
pipelined processing (33.2ms for 4 frames).
...
\begin{itemize}
  ...
  \item \textbf{Accuracy Preservation}: Maintained 98.8\% IoU
