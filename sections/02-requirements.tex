\chapter{Requirements, Constraints, and Standards}\label{chap:requirements}
...
\item \textbf{Memory Limitations:}
   \begin{itemize}
   \item The Xilinx Kria K26 board has 4GB of DDR memory, which must be shared among the pipeline stages.
   \item Optimize memory usage to avoid contention between stages and ensure smooth data flow.
   \end{itemize}
...
\begin{description}
\item[IEEE 2952-2023] \textit{IEEE Standard for Secure Computing Based on Trusted Execution Environment} \\
...
\item[IEEE 2802-2022] \textit{IEEE Standard for Performance and Safety Evaluation of AI-Based Medical Devices: Terminology} \\
...
\item[IEEE 7002-2022] \textit{IEEE Standard for Data Privacy Process} \\
...
\item[IEEE 3129-2023] \textit{IEEE Standard for Robustness Testing and Evaluation of AI-Based Image Recognition Services} \\
...
\item[IEEE 3156-2023] \textit{IEEE Standard for Requirements of Privacy-Preserving Computation Integrated Platforms} \\
...
\item[IEEE 2842-2021] \textit{IEEE Recommended Practice for Secure Multi-Party Computation} \\
...
\item[IEEE 1484.1-2003] \textit{IEEE Standard for Learning Technology - Learning Technology Systems Architecture (LTSA)} \\
