...
\item \textbf{Algorithm Optimization and Pipelining:}
   ...
   \item Ensure the pipeline maintains data consistency and synchronization between stages with proper DPU scheduling across algorithms (see Section~\ref{design:dpu-scheduling} for design approach).
   \end{itemize}
...
\item \textbf{Resource Efficiency:}
   ...
   \item Ensure efficient sequential scheduling of the DPU among semantic segmentation and other algorithms (design approach detailed in Section~\ref{design:dpu-scheduling}).
   \end{itemize}
...
\item \textbf{FPGA Resource Allocation:}
   ...
   \item Ensure that the Deep Learning Processing Unit (DPU) is shared effectively between semantic segmentation, blink detection, and eye-tracking algorithms through sequential scheduling (design approach in Section~\ref{design:dpu-scheduling}).
   \end{itemize}
\end{enumerate}
