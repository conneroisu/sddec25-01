...
\note{Numerical values are representative placeholders due to NDA restrictions.}
...
\begin{itemize}
\item Testing each part of the divided U-Net algorithm as we create it
\item Checking memory use before building the full system
\item Testing how we share DPU resources as we develop
\end{itemize}
...
\item Making sure our parallel threads work together correctly
\item Balancing speed and accuracy
\item Checking that memory is used correctly
\end{itemize}
...
\textbf{Performance Tracking}: Use Vitis AI Profiler to watch:
\begin{itemize}
\item Running time
\item DPU use
\item Memory use
...
\begin{itemize}
\item \textbf{IEEE 3129-2023}: Robustness testing and evaluation of AI-based image recognition services
\item \textbf{IEEE 2802-2022}: Performance and safety evaluation of AI-based medical devices
\item \textbf{IEEE 7002-2022}: Data privacy process compliance validation
\end{itemize}
