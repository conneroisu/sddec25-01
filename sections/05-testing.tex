...
\begin{itemize}
  ...
  \item Validation that semantic segmentation, eye tracking, and blink
    detection algorithms can reliably collect data without interruption
\end{itemize}
...
\begin{itemize}
  \item Verified all algorithms (semantic segmentation, eye tracking,
    and blink detection) worked together without conflicts
