...
The project follows a hybrid Waterfall + Agile project management approach. This methodology provides both the structured framework of Waterfall for critical path activities and the flexibility of Agile for iterative development and testing. This hybrid approach was particularly well-suited because:
...
These tasks were broken down into sprint activities with team members assigned based on expertise. The decomposition follows the natural dependencies in the system: algorithm optimization must precede implementation, thread management enables multicore processing, and all components integrate before final testing. This structure ensures each phase builds on validated foundations from prior work.
