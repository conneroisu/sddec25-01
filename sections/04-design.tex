...
and sequential DPU execution achieves less than 10ms per frame average
(less than 35ms total for 4 frames), a nearly 5x speed increase.
...
Single model: approximately 500--600 ms latency (approximately 2 FPS) with approximately 98--99\% IoU accuracy.
Split model (4 segments): approximately 4500--5500 ms latency (approximately 0.2 FPS), revealing the
single model is approximately 9--10x faster than the split architecture.
