...
\begin{itemize}
	...
	\item \textbf{Challenge Factors}: Dataset includes reflections,
	      occlusions, motion blur, and variable pupil sizes representative
	      of real-world deployment conditions
	\item \textbf{Medical Relevance}: OpenEDS designed for assistive
	      technology applications, aligning with project's medical monitoring use case
\end{itemize}
