...
\begin{itemize}
	\item \textbf{Mean Total Latency}: $\sim$600 ms
	\item \textbf{Mean DPU Time}: $\sim$500 ms
	\item \textbf{Mean Preprocess}: 49 ms
	\item \textbf{Mean Postprocess}: 51 ms
	\item \textbf{Memory Usage}: $\sim$50 MB
\end{itemize}
...
\begin{itemize}
	\item \textbf{Mean Total Latency}: 850 ms
	\item \textbf{Mean DPU Time}: $\sim$750 ms
	\item \textbf{Mean Preprocess}: $\sim$49 ms
	\item \textbf{Mean Postprocess}: $\sim$51 ms
\end{itemize}
