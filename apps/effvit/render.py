"""
Render TinyEfficientViTSeg model architecture using torchview.
"""
...
def render_model(
    ...
    """
    Render the TinyEfficientViTSeg model architecture to an image.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Render TinyEfficientViTSeg model architecture"
    )
    parser.add_argument(
        "-o",
        "--output",
